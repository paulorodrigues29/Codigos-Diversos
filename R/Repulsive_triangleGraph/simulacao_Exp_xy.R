simulacao = function(bv1=1,bv2=1,bv3=1,
  ...
  while(t<=i){
      ...
      pb1 = exp(-alfa*va1)/(exp(-alfa*va1)+exp(-alfa*va2))
      pb2 = 1-pb1
      ##Probabilidade das azuis
      pa1 = exp(-alfa*vb1)/(exp(-alfa*vb1)+exp(-alfa*vb2))
      pa2 = 1-pa1
      ...
      ##--------------
      ##Probabilidade das brancas
      pb2 = exp(-alfa*va2)/(exp(-alfa*va2)+exp(-alfa*va3))
      pb3 = 1-pb2
      ##Probabilidade das azuis
      pa2 = exp(-alfa*vb2)/(exp(-alfa*vb2)+exp(-alfa*vb3))
      pa3 = 1-pa2    
      ##gerando um valor aleatório entre 0 e 1 para as bolas brancas
      valor = runif(1,0,1)
      ##Verificando para qual vértice as bolas brancas irao
      ...
      ##--------------
      ##Probabilidade das brancas
      pb1 = exp(-alfa*va1)/(exp(-alfa*va1)+exp(-alfa*va3))
      pb3 = 1-pb1
      ##Probabilidade das azuis
      pa1 = exp(-alfa*vb1)/(exp(-alfa*vb1)+exp(-alfa*vb3))
      pa3 = 1-pa1
      ##gerando um valor aleatório entre 0 e 1 para as bolas brancas
      valor = runif(1,0,1)
      ##Verificando para qual vértice as bolas brancas irao
