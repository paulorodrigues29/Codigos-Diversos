## Exemplos
##
## simulacao(4,10,2,4,2,10,i=400000,seed=2,plt=TRUE,plty="t",alfa=19)
##
## simulacao(4,10,2,4,2,10,i=100000,seed=2,plt=TRUE,plty="t",alfa=10)
## -------- next line takes hours to execute !!!!
## dt <- simulacao(5,1,15,5,15,2,i=2000000,seed=31,plt=TRUE,plty="t",alfa=13)
## dt2 <- dt[seq(4000,2000000, 800), ]
## dt3 <- dt[1:3999, ]
## hey <- rbind(dt3, dt2)
## write.table(hey, file="hey.txt", col.names=TRUE, row.names=FALSE)
## -------
# hey <- read.table("hey.txt", header=TRUE)
# colA <- "black"                                                
# colB <- "#d73027"
# plot(hey$b.x, hey$b.y, type="l", xlim=c(0,1),ylim=c(0,sqrt(3)/2), axes=F, xlab="", ylab="", col=colA, lwd=1.75)
# lines(hey$a.x, hey$a.y, col=colB, lwd=1.75);
# segments(0,0,1/2,sqrt(3)/2, lwd=1)                                     
# segments(1,0,1/2,sqrt(3)/2, lwd=1)                                 
# segments(0,0,1,0, lwd=1)
## --------------
# hey <- read.table("hey.txt", header=TRUE)
# d<-simulacao(15,2,1,2,1,10,i=3000,seed=116654,plt=TRUE,plty="t",alfa=13)
# lines(hey$b.x, hey$b.y, col=colA, lwd=1.75);
# lines(hey$a.x, hey$a.y, col=colB, lwd=1.75);
